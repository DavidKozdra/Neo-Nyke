const ACHIEVEMENTS = [
  ...
  { id: 'the_avatar',     name: 'I Am the Avatar',  desc: 'Apply 4+ status effects on one enemy',  icon: '≋' },
  ...
  { id: 'shopping_spree', name: 'Shopping Spree',   desc: 'Buy 50 items from shops in one run',    icon: '◎' },
...
const ACHIEVEMENT_PROGRESS = {
  ...
  hoarder:        { key: 'maxRelicCount', target: 100, label: 'Relics held' },
  ...
  shopping_spree: { key: 'runShopBuys', target: 50, label: 'Shop buys this run' },
