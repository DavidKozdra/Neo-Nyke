// game-core.js — standalone IIFE. Defines constants and canvas/ctx.
// Exposes shared constants on window.Neo after definition.
(() => {
  ...
  // perfState is created in perf.js and exposed as Neo.perfState
  ...
  // Expose constants and canvas/ctx on Neo so all other files can access them.
  Neo.canvas = canvas;
  Neo.ctx = ctx;
  Neo.ROOM_W = ROOM_W;
  Neo.ROOM_H = ROOM_H;
