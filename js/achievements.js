const ACHIEVEMENTS = [
  ...
  { id: 'gotta_meet_god', name: 'Gotta Meet God',   desc: 'Reach floor 10 in under 5 minutes',     icon: '⚡' },
  ...
  { id: 'floor_muncher',  name: 'Floor Muncher',    desc: 'Reach 100 floors total',                icon: '↟' },
  ...
  { id: 'godloop',        name: 'Godloop',          desc: 'Complete 20 loops in a single run',     icon: '∞' },
...
const ACHIEVEMENT_PROGRESS = {
  ...
  floor_muncher:  { key: 'floors_entered', target: 100, label: 'Floors entered' },
  ...
  godloop:        { key: 'maxLoopIndex', target: 20, label: 'Loops this run' },
