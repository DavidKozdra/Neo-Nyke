...
export const MOVE_DEFS = {
    ...
    holy_eye_beams: { key: 'holy_eye_beams', slot: 'laser', name: 'Holy Eye Beams', desc: 'Channel twin holy beams from your eyes. Each cast has a chance to heal you 5% max HP.', exclusiveCharacter: 'gelleh' },
...
export const RIVAL_DAMAGE_REDUCTION = 0.05; // slight toughness without making ordinary hits feel blocked
...
const sharedItemDefinitions = globalThis.NeoNyke?.content || {};
export const ITEM_DEFS = sharedItemDefinitions.ITEM_DEFS;
export const ITEM_SHORT_DESCRIPTIONS = sharedItemDefinitions.ITEM_SHORT_DESCRIPTIONS;
export const getItemShortDescription = sharedItemDefinitions.getItemShortDescription;
export const SCROLL_DEFS = sharedItemDefinitions.SCROLL_DEFS;
export const SCROLL_KEYS = sharedItemDefinitions.SCROLL_KEYS;
...
export const ui = {
    ...
    shopAllies: document.getElementById('shopAllies'),
    ...
    invAlliesList: document.getElementById('invAlliesList'),
    ...
    bossRushSlotLabel: document.getElementById('bossRushSlotLabel'),
    bossRushStageNum2: document.getElementById('bossRushStageNum2'),
    bossRushStageTotal2: document.getElementById('bossRushStageTotal2'),
    ...
    modsChallengesPane: document.getElementById('modsChallengesPane'),
    modsChaosPane: document.getElementById('modsChaosPane'),
    modsLegacyPane: document.getElementById('modsLegacyPane'),
    chaosHint: document.getElementById('chaosHint'),
    architectEditor: document.getElementById('architectEditor'),
    architectGrid: document.getElementById('architectGrid'),
    architectStatus: document.getElementById('architectStatus'),
    architectClear: document.getElementById('architectClear'),
    ...
    multiplayerPublicLobbyRefresh: document.getElementById('multiplayerPublicLobbyRefresh'),
    multiplayerPublicLobbyStatus: document.getElementById('multiplayerPublicLobbyStatus'),
    multiplayerPublicLobbyList: document.getElementById('multiplayerPublicLobbyList'),
    ...
    multiplayerCopyInviteLink: document.getElementById('multiplayerCopyInviteLink'),
    ...
    multiplayerEndScreen: document.getElementById('multiplayerEndScreen'),
    multiplayerEndTitle: document.getElementById('multiplayerEndTitle'),
    multiplayerEndSummary: document.getElementById('multiplayerEndSummary'),
    multiplayerEndPlayers: document.getElementById('multiplayerEndPlayers'),
    multiplayerRematchStatus: document.getElementById('multiplayerRematchStatus'),
    multiplayerRematch: document.getElementById('multiplayerRematch'),
    multiplayerEndMenu: document.getElementById('multiplayerEndMenu'),
    ...
    coopLobbyCopyInviteLink: document.getElementById('coopLobbyCopyInviteLink'),
    ...
    coopLobbyPauseModeState: document.getElementById('coopLobbyPauseModeState'),
    coopLobbyPauseModeHint: document.getElementById('coopLobbyPauseModeHint'),
    ...
    anvilPaySwitch: document.querySelector('#anvilPanel .anvil-pay-switch'),
    anvilPayXp: document.getElementById('anvilPayXp'),
    anvilPayGold: document.getElementById('anvilPayGold'),
    anvilPayXpWallet: document.getElementById('anvilPayXpWallet'),
    anvilPayGoldWallet: document.getElementById('anvilPayGoldWallet'),
    ...
    altModeSeedSpeedRunBtn: document.getElementById('altModeSeedSpeedRunBtn'),
    ...
    chaosButtons: [...document.querySelectorAll('#chaosSelect .challenge-btn')],
    architectTools: [...document.querySelectorAll('#architectEditor .architect-tool')],
    legacyPanel: document.getElementById('challengePanel'),
    legacyToggle: null,
    legacyClose: null,
...
export const MOVE_BASE_STATS = globalThis.NeoNyke?.content?.MOVE_BASE_STATS || {
    ...
    holy_turrets:     { damage: 17,  cooldown: 6.50, duration: 6.0, range: 360 },
