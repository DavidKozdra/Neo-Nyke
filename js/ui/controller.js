...
export function createUIController(view) {
    ...
    const ENEMY_INFO = [
      ...
      { key: 'antony_blemmye',  label: 'Antony Blemmyae',  boss: true,  hp: 1400, dmg: 27, speed: 82,  attackStyle: 'melee',   immunities: ['bleed'],                             desc: 'Boss. Chest-faced bruiser. Up close he bites to drain HP or sweeps a wide slash; his hammer sends a shockwave forward and he charges a cold death ball at range.' },
