...
export const ITEM_DEFS = {
    ...
    iron_helm: {
      ...
      description: 'Tool. Add a diamond shield worth 250% of max HP. Reusing refreshes the shield to that amount.',
      rarity: 'god',
      color: '#c8fbff',
      accent: '#f5feff',
      category: 'god',
    ...
    el_bartos_cape: {
      ...
      shortName: 'CAPE',
      description: 'Tool. Become invisible for 10 seconds; attacks do not break it. Each stack adds +5 seconds and a +10% chance on use to leave damaging El Barto graffiti.',
      rarity: 'god',
      color: '#ff5b78',
      accent: '#ffe0b8',
      category: 'god',
