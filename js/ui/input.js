...
export const ITEM_DEFS = {
    ...
    artificer_charger: {
      ...
      description: 'A great tool of the cult; in holy hands it can send light. Doubles your current level, improves every future level gain, and makes your sprite and AOEs 26.7% larger. Lasers are 5% wider. Picking up a second one costs 1 Loop Crystal to contain — with no crystals, it kills you.',
      rarity: 'blue',
      color: '#69c8ff',
      accent: '#fff3ae',
      category: 'artificer',
    ...
    el_bartos_cape: {
      ...
      shortName: 'CAPE',
      description: 'Tool. Activate for 10 seconds; you are invisible for the first half, then fade back into view. Each stack adds +5 seconds and a +10% chance on use to leave damaging El Barto graffiti.',
      rarity: 'god',
      color: '#ff5b78',
      accent: '#ffe0b8',
      category: 'god',
